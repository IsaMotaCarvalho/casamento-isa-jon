...
export default function GuestPage() {
    ...
    // Estado do Lembrete Elegante Ativo
    ...
    useEffect(() => {
        ...
        // Verifica se há alguma intenção de presente salva localmente no navegador
    ...
    const handleSelectGiftQuota = async (gift: any, quantity: number) => {
        ...
        // Faz o incremento de múltiplas cotas no banco de dados
    ...
    return (
        <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-amber-100 relative pt-12">
            ...
            {/* Componente Modal de Pagamento PIX com Valores Dinâmicos */}
            <PixModal
